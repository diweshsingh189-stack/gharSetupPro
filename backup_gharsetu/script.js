...
const items = [
    {
        name: "Cement",
        icon: "🧱",
        purpose: "Concrete, mortar, plaster and masonry work.",
        quantity: 450,
        unit: "Bag",
        rate: 415,
        type: "material",
    ...
    },
    {
        name: "Sand",
        icon: "🏖️",
        purpose: "Concrete, mortar and plaster.",
        quantity: 2500,
        unit: "CFT",
        rate: 55,
        type: "material",
    ...
    {
        name: "Aggregate / Gitti",
        icon: "🪨",
        purpose: "Concrete for RCC and PCC.",
        quantity: 1800,
        unit: "CFT",
        rate: 65,
        type: "material",
    ...
    },
    {
        name: "TMT Steel",
        icon: "🏗️",
        purpose: "Reinforcement inside columns, beams and slabs.",
        quantity: 4000,
        unit: "Kg",
        rate: 72,
        type: "material",
    ...
    },
    {
        name: "Bricks",
        icon: "🧱",
        purpose: "Internal and external walls.",
        quantity: 18000,
        unit: "Piece",
        rate: 9,
        type: "material",
    ...
    },
    {
        name: "Binding Wire",
        icon: "🪢",
        purpose: "Tying steel reinforcement bars.",
        quantity: 70,
        unit: "Kg",
        rate: 85,
        type: "material",
    ...
    },
    {
        name: "Stone Dust",
        icon: "🪨",
        purpose: "Filling, bedding and selected construction work.",
        quantity: 500,
        unit: "CFT",
        rate: 40,
        type: "material",
    ...
    },
    {
        name: "Excavation",
        icon: "🚜",
        purpose: "Foundation trenches and pits.",
        quantity: 450,
        unit: "CFT",
        rate: 45,
        type: "labour",
    ...
    },
    {
        name: "PCC",
        icon: "🏗️",
        purpose: "Stable base below foundation.",
        quantity: 120,
        unit: "CFT",
        rate: 90,
        type: "labour",
    ...
    },
    {
        name: "RCC Work",
        icon: "🏗️",
        purpose: "Slabs, beams, columns and structural elements.",
        quantity: 1500,
        unit: "CFT",
        rate: 320,
        type: "labour",
    ...
    },
    {
        name: "Brick Masonry",
        icon: "🧱",
        purpose: "Construction of walls and partitions.",
        quantity: 6000,
        unit: "CFT",
        rate: 95,
        type: "labour",
    ...
    },
    {
        name: "Plaster",
        icon: "🪵",
        purpose: "Smooth protective surface for walls and ceilings.",
        quantity: 7500,
        unit: "Sq.Ft",
        rate: 28,
        type: "other",
    ...
    },
    {
        name: "Waterproofing",
        icon: "💧",
        purpose: "Protects roofs, bathrooms and wet areas.",
        quantity: 1000,
        unit: "Sq.Ft",
        rate: 45,
        type: "other",
    ...
    },
    {
        name: "Flooring",
        icon: "🪨",
        purpose: "Finished walking surface.",
        quantity: 1500,
        unit: "Sq.Ft",
        rate: 90,
        type: "other",
    ...
    },
    {
        name: "Doors & Windows",
        icon: "🚪",
        purpose: "Access, ventilation, daylight and security.",
        quantity: 1,
        unit: "Lot",
        rate: 220000,
        type: "other",
    ...
    },
    {
        name: "Electrical",
        icon: "⚡",
        purpose: "Wiring, switches, sockets and lighting.",
        quantity: 1500,
        unit: "Sq.Ft",
        rate: 110,
        type: "other",
    ...
    },
    {
        name: "Plumbing",
        icon: "🚰",
        purpose: "Fresh water and wastewater systems.",
        quantity: 1500,
        unit: "Sq.Ft",
        rate: 90,
        type: "other",
    ...
    },
    {
        ...
        icon: "🚿",
        purpose: "WC, basin, shower and bathroom fittings.",
        quantity: 1,
        unit: "Lot",
        rate: 120000,
        type: "other",
    ...
    },
    {
        name: "Painting",
        icon: "🎨",
        purpose: "Surface protection and final appearance.",
        quantity: 5000,
        unit: "Sq.Ft",
        rate: 30,
        type: "other",
    ...
    },
    {
        name: "Kitchen",
        icon: "🍳",
        purpose: "Cabinets, countertop and kitchen fittings.",
        quantity: 1,
        unit: "Lot",
        rate: 180000,
        type: "other",
    ...
    },
    {
        name: "General Labour",
        icon: "👷",
        purpose: "Masonry, material handling and general work.",
        quantity: 450,
        unit: "Worker-Day",
        rate: 850,
        type: "labour",
    ...
    },
    {
        name: "Miscellaneous",
        icon: "📦",
        purpose: "Tools, transport, wastage and minor expenses.",
        quantity: 1,
        unit: "Lot",
        rate: 100000,
        type: "other",
...
const toolsCatalog = [
    {
        ...
        icon: "📐",
        targetId: "floorLength",
        page: "measurements",
        description: "Calculate square footage for rooms and floors."
    },
    {
        id: "wall-calc",
        name: "Wall & Plaster Area Calculator",
        icon: "🧱",
        targetId: "wallLength",
        page: "measurements",
        description: "Calculate wall area deducting doors and windows."
    },
    {
        id: "concrete-calc",
        name: "Concrete Volume Calculator",
        icon: "🏗️",
        targetId: "concreteLength",
        page: "measurements",
        description: "Calculate rectangular concrete volume in cubic ft."
    },
    {
        id: "cost-calc",
        name: "Area Cost Estimator",
        icon: "💰",
        targetId: "costArea",
        page: "measurements",
        description: "Estimate overall budget for any specific area."
    }
];
...
function playSound(type) {
    ...
    try {
        ...
        if (type === "click") {
            // Crisp, gentle modern click/tap sound
            ...
            // Melodic dual-tone success chime
            ...
            // Soft low warning buzz for missing input / error
            [220, 180].forEach((freq, idx) => {
                ...
                // Lowpass filter for smooth buzz
...
// Global click listener for sounds on interactive elements
...
function showPage(page, button = null) {
    ...
    // Refresh on-page search filtering if search query exists
...
function showMaterialModal(index) {
    ...
    if (comp && comp.companies.length > 0) {
        ...
        companiesHTML = '<p style="color:var(--text-muted);margin-top:12px;">Rates vary by location. Get 3 quotes before buying.</p>';
    }

    document.getElementById('modalTitle').textContent = item.icon + ' ' + item.name;
...
document.addEventListener('keydown', (event) => {
    if (event.key === 'Escape') closeMaterialModal();
});
...
function calculateFloor() {
    ...
    if (hasError) {
        playSound("error");
        showToast("⚠️ Please fill all required fields in red!");
        return;
    }
...
function calculateWall() {
    ...
    const opening = Number(openingVal) || 0;
...
const twentyDayPlan = [
    ["01", "Planning", "Freeze drawings, grid lines and levels", "Cement 2 bags · Marking powder 5 Kg", "images/gallery/house_1.jpg", "Approved drawings", "Grid and benchmark ready"],
    ["02", "Site setup", "Barricading, access and material storage", "Sand 10 CFT · Water 500 L", "images/gallery/house_2.jpg", "Day 01", "Safe work zone ready"],
    ["03", "Excavation", "Excavate foundation trenches to design depth", "Stone dust 20 CFT · Sand 10 CFT", "images/gallery/house_3.jpg", "Site setup", "Formation level achieved"],
    ["04", "PCC", "Lay lean concrete below footings", "Cement 12 bags · Aggregate 40 CFT · Sand 20 CFT", "images/gallery/house_4.jpg", "Excavation", "Clean, level PCC bed"],
    ["05", "Footing steel", "Fix reinforcement with cover blocks", "Steel 140 Kg · Binding wire 4 Kg", "images/gallery/house_5.jpg", "PCC cured", "Steel inspected before pour"],
    ["06", "Footing concrete", "Pour, compact and finish isolated footings", "Cement 35 bags · Aggregate 110 CFT", "images/gallery/house_6.jpg", "Footing steel", "Footings poured and logged"],
    ["07", "Plinth beam steel", "Fix plinth beam reinforcement and shuttering", "Steel 120 Kg · Binding wire 3 Kg", "images/gallery/house_7.jpg", "Footing concrete", "Beam cage ready"],
    ["08", "Plinth beam", "Concrete plinth beam and damp-proof course", "Cement 18 bags · Aggregate 55 CFT · Bricks 500", "images/gallery/house_8.jpg", "Beam steel", "Plinth line established"],
    ["09", "Filling", "Backfill in controlled layers and compact", "Stone dust 100 CFT", "images/gallery/house_9.jpg", "Plinth beam", "Compacted filling complete"],
    ["10", "Floor base", "Prepare soling and ground floor base", "Stone dust 80 CFT · Sand 60 CFT", "images/gallery/house_10.jpg", "Filling", "Floor base level checked"],
    ["11", "Column steel", "Fix starter bars and column reinforcement", "Steel 190 Kg · Binding wire 5 Kg", "images/gallery/house_5.jpg", "Plinth level", "Vertical alignment checked"],
    ["12", "Columns", "Erect shuttering and cast columns", "Cement 22 bags · Aggregate 70 CFT", "images/gallery/house_6.jpg", "Column steel", "Column pour complete"],
    ["13", "Beam steel", "Fix beams, lintels and slab supports", "Steel 260 Kg · Binding wire 7 Kg", "images/gallery/house_7.jpg", "Columns cured", "Beam reinforcement inspected"],
    ["14", "Roof shuttering", "Level slab shuttering and edge forms", "Props 80 nos · Plywood 300 Sq.Ft", "images/gallery/house_8.jpg", "Beam steel", "Slab formwork level"],
    ["15", "Roof services", "Place sleeves, conduits and slab steel", "Steel 420 Kg · Conduit 180 m", "images/gallery/house_9.jpg", "Roof shuttering", "Embedded services recorded"],
    ["16", "Roof concrete", "Pour slab, vibrate and start curing", "Cement 48 bags · Aggregate 150 CFT · Sand 75 CFT", "images/gallery/house_10.jpg", "Roof inspection", "Slab pour completed"],
    ["17", "Masonry", "Build external and internal brick walls", "Bricks 4,000 · Cement 18 bags · Sand 120 CFT", "images/gallery/house_1.jpg", "Slab curing", "Wall alignment checked"],
    ["18", "MEP rough-in", "Install electrical conduits and plumbing lines", "PVC pipe 120 m · Conduit 180 m", "images/gallery/house_2.jpg", "Masonry openings", "Pressure and route test ready"],
    ["19", "Plaster & waterproofing", "Plaster surfaces and waterproof wet areas", "Cement 25 bags · Sand 160 CFT · Waterproofing 500 Sq.Ft", "images/gallery/house_3.jpg", "MEP rough-in", "Wet-area test passed"],
    ["20", "Handover checks", "Flooring sample, paint touch-up, testing and snag list", "Tiles 1,000 Sq.Ft · Putty 20 bags · Paint 40 L", "images/gallery/house_4.jpg", "All prior inspections", "Snag list and handover record"]
];
...
function renderStages() {
    ...
    stages.forEach((stage, index) => {
        roadmap.innerHTML += `
            <div class="stage stage-clickable" id="stage-card-${index}" data-search="${stage[1].toLowerCase()} ${stage[2].toLowerCase()}" onclick="showConstructionPreview('${stage[1]}', '${stage[2]}', 'Stage ${stage[0]}', 'images/gallery/house_${(index % 10) + 1}.jpg')" tabindex="0" role="button">
...
function renderTwentyDayPlan() {
    ...
    plan.innerHTML = twentyDayPlan.map((day, index) => `
        <button class="day-card" title="${day[1]}: ${day[2]}" style="--bar-width: ${((index + 1) / twentyDayPlan.length) * 100}%" onclick="showConstructionPreview('${day[1]}', '${day[2]}', 'Day ${day[0]}', '${day[4]}', '${day[3]}')" aria-label="View ${day[1]} for day ${day[0]}">
    ...
    if (technicalPlan) {
        technicalPlan.innerHTML = `<div class="technical-plan-head"><span>EXECUTION REGISTER</span><strong>Daily work packages</strong></div>` + twentyDayPlan.map(day => `
            <button class="technical-row" onclick="showConstructionPreview('${day[1]}', '${day[2]}', 'DAY ${day[0]} · ${day[1]}', '${day[4]}', '${day[3]}')">
...
function submitFeedback() {
    ...
    if (msgEl) msgEl.innerText = "✅ Thank you! Your feedback has been saved.";
...
function globalSearch() {
    ...
    // Build unified results list for keyboard navigation
    searchResultsCache = [];
    ...
    if (totalCount === 0) {
        html = `<div class="search-empty">🔍 No matching materials, tools, or stages found for "<strong>${query}</strong>"</div>`;
    }
    ...
    if (pageId === "materials") {
        ...
        if (feedbackMsg) {
            if (query && matchCount === 0) {
                ...
                feedbackMsg.innerHTML = `🔍 No materials match "<strong>${query}</strong>". Try searching for Cement, Sand, Steel, Paint, etc.`;
            } else if (query) {
                feedbackMsg.style.display = "block";
...
function selectSearchResult(index) {
    ...
    // Scroll to & highlight target element
    if (result.targetId) {
        setTimeout(() => {
...
function loadProject() {
    ...
    try {
        ...
        if (lengthEl) lengthEl.value = project.length || 50;

        const widthEl = document.getElementById("width");
        if (widthEl) widthEl.value = project.width || 30;

        const floorsEl = document.getElementById("floors");
        if (floorsEl) floorsEl.value = project.floors || 1;

        if (Array.isArray(project.items)) {
            project.items.forEach((savedItem, index) => {
                if (items[index]) {
                    items[index].quantity = savedItem.quantity;
                    items[index].rate = savedItem.rate;
                }
            });
        }
    } catch(error) {
...
/* =====================================================
        TRENDING 10 HOUSE GALLERY CONTROLS & LIGHTBOX
===================================================== */
...
function toggleGalleryPlay() {
    ...
    track.style.animationPlayState = isGalleryPaused ? "paused" : "running";
    btn.innerText = isGalleryPaused ? "▶" : "⏸";
    playSound("switch");
    showToast(isGalleryPaused ? "Gallery motion: Paused ⏸" : "Gallery motion: Playing ▶");
}

// ===== TRENDING PHOTO GALLERY FUNCTIONS =====

const galleryPhotos = [
    { src: 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=1200&h=800&fit=crop&q=90', label: 'ðŸ  Minimalist White Villa', area: '4BHK â€¢ 3,200 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1200&h=800&fit=crop&q=90', label: 'âœ¨ Luxury Pool Villa', area: '5BHK â€¢ 4,500 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=1200&h=800&fit=crop&q=90', label: 'ðŸ¤– Smart Contemporary Home', area: '3BHK â€¢ 2,400 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?w=1200&h=800&fit=crop&q=90', label: 'ðŸªŸ Glass & Steel Design', area: '4BHK â€¢ 3,600 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1523217582562-09d0def993a6?w=1200&h=800&fit=crop&q=90', label: 'ðŸ˜ï¸ Premium Bungalow', area: '4BHK â€¢ 3,000 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&h=800&fit=crop&q=90', label: 'ðŸŒ¿ Eco Green Smart Home', area: '3BHK â€¢ 2,100 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1200&h=800&fit=crop&q=90', label: 'ðŸ”ï¸ Ultra Modern Duplex', area: '5BHK â€¢ 4,800 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&h=800&fit=crop&q=90', label: 'ðŸ’Ž White Luxury Mansion', area: '6BHK â€¢ 6,000 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&h=800&fit=crop&q=90', label: 'â„ï¸ Scandinavian Style Home', area: '3BHK â€¢ 2,200 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=1200&h=800&fit=crop&q=90', label: 'ðŸŒ´ Tropical Resort Villa', area: '4BHK â€¢ 3,500 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=1200&h=800&fit=crop&q=90', label: 'ðŸ  Warm Courtyard House', area: '3BHK â€¢ 2,700 sq.ft â€¢ 2026 Trending' },
    { src: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=1200&h=800&fit=crop&q=90', label: 'ðŸ¡ Modern Family Residence', area: '4BHK â€¢ 3,800 sq.ft â€¢ 2026 Trending' }
];
...
function openGalleryLightbox(index) {
    ...
    img.src = photo.src;
    img.alt = photo.label;
    if (caption) caption.textContent = photo.label + ' â€” ' + photo.area;
